    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if nextState in state[1]:
                ...
                successors.append( (nextState,state),tuple(foodlist),action,1)
            else:
                successors
...
def cornersHeuristic(state, problem):
    ...
    for food in state[1]:
        xy2=food
        tmpdist=abs(xy1[0]-xy2[0])+abs(xy1[1]-xy2[1])
        if(tmpdist < minDistancetoFood):
            minDistancetoFood=tmpdist
            minDistanceFood=xy2
    ...
    return minDistancetoFood  #addition of distances in nearest food  path
